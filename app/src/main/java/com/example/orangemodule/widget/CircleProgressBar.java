package com.example.orangemodule.widget;
...
import com.example.orangemodule.utils.CircleUtils;
...
public class CircleProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 绘制底部背景图
        bmpTemp = CircleUtils.decodeCustomRes(getContext(), R.drawable.arc_progress);
        ...
        bmpTemp = CircleUtils.decodeCustomRes(getContext(), R.drawable.arc_bg);
        ...
        if (isDisplayText && percent != 0) {
            canvas.drawText(progress + "", centerX - textWidth / 2, centerX
                    + textSize / 2 - 25, paint);
        }
        //画底部开口处标题文字
